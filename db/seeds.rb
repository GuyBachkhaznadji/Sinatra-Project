...
gladiator1 = Gladiator.new({'name' => "Tiberius Maximus"}, creature_type4)
gladiator1.save

gladiator2 = Gladiator.new({'name' => "Atlas Nero"}, creature_type4)
gladiator2.save

creature2 = Creature.new({'name' => "Smaug, The Terrible", 'type' => "Dragon", 'capture_date' => "15/10/0500", 'fightable' => 'f', 'level' => 1, "exp" => 0}, creature_type1)
creature2.save
creature2.update

creature3 = Creature.new({'name' => "Leo, The Loud", 'type' => "Lion", 'capture_date' => "15/10/0235", 'fightable' => 'f', 'level' => 1, "exp" => 0}, creature_type2)
creature3.save
creature3.update

creature1 = Creature.new({'name' => "Nembit, The Firestarter", 'type' => "Dragon", 'capture_date' => "5/5/0100", 'fightable' => 't', 'gladiator_id' => gladiator1.id, 'level' => 1, "exp" => 0}, creature_type1)
creature1.save
creature1.update

creature4 = Creature.new({'name' => "Ursa, The Tall",'type' => "Bear", 'capture_date' => "15/10/0235", 'fightable' => 'f', 'level' => 1, "exp" => 0}, creature_type3)
creature4.save
creature4.update
